...
<asp:Content runat="server" ID="myContent" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Label ID="Label12" runat="server" CssClass="treeNode" Text="PRODUCTOS WSM"></asp:Label>
    <br />
    <br />
    <!DOCTYPE html>
        ...
        <table >
            <tr>
                ...
                <td >
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" CssClass="gridcalc" Width="730px" >
                        <Columns>
