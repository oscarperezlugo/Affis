            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="col-3">
                        ...
                        <asp:TextBox ID="TextBox6" runat="server" CssClass="form-control" Width="100%" placeholder="Código"></asp:TextBox>
                        <br />
                    </div>
                    <div class="col-5">
                        <asp:Label ID="Label11" runat="server" CssClass="texto" Text="Producto"></asp:Label>
                        <asp:TextBox ID="TextBox7" runat="server" CssClass="form-control" Width="100%" placeholder="Producto"></asp:TextBox>
                        <br />
                    </div>
                    <div class="col-2">
                ...
                <div class="form-row">
                    ...
                    <div class="col-3">
                        ...
                        <asp:TextBox ID="TextBox5" runat="server" CssClass="form-control" Width="100%" placeholder="Valor $"></asp:TextBox>
                    </div>
                    <div class="col-2">
                        <asp:Label ID="Label99" runat="server" CssClass="texto" Text="Valor $" Visible="false"></asp:Label><br />
