...
namespace Affis
{
    ...
    public partial class Reemplazo3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
                recuperarInfo();
            if (Session["reemplazo"] != null)
            {
                  TextBox1.Text = Session["reemplazo"].ToString();
                if (Session["tomasegur"] != null) 
                {
                    ...
                    DropDownList4.SelectedValue = Session["dia"].ToString();
                    DropDownList3.SelectedValue = Session["mes"].ToString();
                    DropDownList2.SelectedValue = Session["ano"].ToString();
            ...
            using (SqlConnection openCon = new SqlConnection("workstation id=Affinity.mssql.somee.com;packet size=4096;user id=operezlugo_SQLLogin_1;pwd=tc65ztfi6o;data source=Affinity.mssql.somee.com;persist security info=False;initial catalog=Affinity"))
            {
                ...
                using (SqlCommand querySaveStaff = new SqlCommand(saveStaff))
                {
                    ...
                    finally 
                    {
                        ...
                        DropDownList3.SelectedValue = "ENERO";
                        DropDownList2.SelectedValue = "1920";
                        Label5.Text = "";
                    }
