...
namespace Affis
{
    ...
    public partial class Reemplazo3 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection openCon = new SqlConnection("workstation id=Affinity.mssql.somee.com;packet size=4096;user id=operezlugo_SQLLogin_1;pwd=tc65ztfi6o;data source=Affinity.mssql.somee.com;persist security info=False;initial catalog=Affinity"))
            {
                ...
                string saveStaff = "INSERT into ASEGURADOS (CEDULA, NOMBRESCOMPLETOS, GENERO, FECHADENACIMIENTO, TOMADOR, RELACION, TOTALPRIMAASEGURADO, PRIMABECAEDUCATIVA, PRIMARENTADIARIAPORHOSPITALIZACION, FECHADEEJECUCIONDELREEMPLAZO) VALUES (@CEDULA, @NOMBRESCOMPLETOS, @GENERO, @FECHADENACIMIENTO, @TOMADOR, @RELACION, @TOTALPRIMAASEGURADO, @PRIMABECAEDUCATIVA, @PRIMARENTADIARIAPORHOSPITALIZACION, @FECHADEEJECUCIONDELREEMPLAZO)";
                ...
                using (SqlCommand querySaveStaff = new SqlCommand(saveStaff))
                {
                    ...
                    querySaveStaff.Parameters.Add("@FECHADENACIMIENTO", SqlDbType.VarChar).Value = DropDownList2.SelectedValue + "/" + DropDownList4.SelectedValue + "/" + DropDownList3.SelectedValue;
                    ...
                    querySaveStaff.Parameters.Add("@FECHADEEJECUCIONDELREEMPLAZO", SqlDbType.VarChar).Value = DateTime.Now.ToString();
                    try
                    {
                        openCon.Open();
