...
namespace Affis
{
    ...
    public partial class Beneficiarios : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE ASEGURADOS SET BENEFICIARIO1=@b1, BENEFICIARIO2=@b2, BENEFICIARIO3=@b3, BENEFICIARIO4=@b4, BENEFICIARIO5=@b5 WHERE CEDULA=@user AND NOMBRESCOMPLETOS=@cer";
