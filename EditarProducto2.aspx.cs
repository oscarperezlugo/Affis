...
namespace Affis
{
    public partial class EditarProducto2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            TextBox6.Text = Session["CodigoCreacion"].ToString();
            TextBox7.Text = Session["producto"].ToString();
            TextBox5.Text = Session["valor"].ToString();
