<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Productoswsm.aspx.cs" Inherits="Affis.Productoswsm" %>
...
<body>
    <form id="form12" runat="server">
        ...
        <div style="background-color:gray" class="auto-style5">
             <asp:Label ID="Label1" runat="server" Text="PRODUCTOS WSM" Font-Bold="True" ForeColor="White" CssClass="subtitulo" ></asp:Label>
        </div>
