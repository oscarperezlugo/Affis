<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Certificado.aspx.cs" Inherits="Affis.Certificado" %>
...
<body>
    <form id="form12" runat="server">
        ...
        <div style="background-color:gray">
             <asp:Label ID="Label1" runat="server" Text="CERTIFICADO" class="subtitulo" ></asp:Label>
        </div>
