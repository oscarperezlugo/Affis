<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Coberturas.aspx.cs" Inherits="Affis.Coberturas" %>
...
<body>
    <form id="form12" runat="server">
        ...
        <div style="background-color:gray">
             <asp:Label ID="Label1" runat="server" Text="CALCULO" class="subtitulo" ></asp:Label>
        </div>
